...
clean:
	$(qecho) Cleaning...
	$(Q)-rm -rf $O
	$(Q)-rm -f rbn rbn.exe librbn.so librbn.a librbn.dll librbn.dylib
	$(Q)-rm -f ./*_m.cc ./*_m.h
	$(Q)-rm -f builder/*_m.cc builder/*_m.h
	$(Q)-rm -f networks/*_m.cc networks/*_m.h
	$(Q)-rm -f node/*_m.cc node/*_m.h
	$(Q)-rm -f parsim/*_m.cc parsim/*_m.h
	$(Q)-rm -f results/*_m.cc results/*_m.h
	$(Q)-rm -f templates/*_m.cc templates/*_m.h
	$(Q)-rm -f templates/randomtopo/*_m.cc templates/randomtopo/*_m.h
...
depend:
	...
	$(Q)$(MAKEDEPEND) $(INCLUDE_PATH) -f Makefile -P\$$O/ -- $(MSG_CC_FILES)  ./*.cc builder/*.cc networks/*.cc node/*.cc parsim/*.cc results/*.cc templates/*.cc templates/randomtopo/*.cc
